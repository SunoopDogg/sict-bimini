...
const ko = {
  ...
  createVersion: {
    ...
    baseNone: '(없음 · 빈 DB)',
    threshold: '신뢰도 임계값',
    addByConfidencePrefix: '신뢰도 ≥',
    addByConfidenceSuffix: '% 객체 추가',
    loadUserInput: '사용자입력 불러오기',
    create: '버전 생성',
    creating: '생성 중…',
    ...
    colSource: '출처',
    colRemove: '삭제',
    deleteSelected: (n: number) => `선택 삭제 (${n})`,
    sourceVersion: '예측 결과 가져오기',
    sourceFile: '예측 파일',
    sourceDb: '예측 DB',
    selectFile: '파일 선택',
    sourceUser: '사용자입력',
  ...
  bimAttr: {
    ...
    versionTitle: (v: string) => `BIM 속성 데이터 — ${v}`,
    view: '데이터 보기',
...
const en: typeof ko = {
  ...
  createVersion: {
    ...
    addByConfidencePrefix: 'Add objects ≥',
    addByConfidenceSuffix: '%',
    loadUserInput: 'Load user input',
    ...
    sourceVersion: 'Import prediction results',
    sourceFile: 'Prediction file',
    sourceDb: 'Prediction DB',
    selectFile: 'Select file',
  ...
  bimAttr: {
    ...
    versionTitle: (v: string) => `BIM Attribute Data — ${v}`,
    view: 'View data',
